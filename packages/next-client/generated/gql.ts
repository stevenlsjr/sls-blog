...
export const ValidPagePathsDocument = gql`
    query ValidPagePaths($rootPageUrl: String) {
  page(urlPath: $rootPageUrl) {
    urlPath
    children {
      urlPath
    }
 ...
 *   variables: {
 *      rootPageUrl: // value for 'rootPageUrl'
 *   },
 * });
 */
